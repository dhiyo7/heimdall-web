...
export const FAQSection: React.FC = () => {
  ...
  return (
    <section id="faq" className="py-20 bg-[var(--color-background)] border-b border-[var(--color-border)] transition-colors duration-300">
            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <h3 className="text-heading-23px text-[var(--color-text-secondary)] font-medium">
                    {t(faq.questionKey)}
                  </h3>
                </div>
                <ChevronDown
